app.factory('PedidosService', function () {
	var pedidos = [
		{
			id: 1,
	...
	var pedidos = [
		{
			id: 1,
			data: '29/11/2015',
			produtos: [{id: 2, nome: 'Vidro laminado Duperu', preco: 22, quantidade: 100, imagem: {
				url: './img/vidro-laminado.jpg'
			}},
					   { id: 10, nome: 'Espelho Banheiro',  preco: 8, quantidade: 10, imagem: {
				url: './img/vidro-espelho.jpg'
			}}],
			total: 2280
		}
